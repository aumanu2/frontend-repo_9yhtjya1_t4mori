    ...
    <header className="sticky top-0 z-20 w-full bg-[#0b1220]/60 backdrop-blur supports-[backdrop-filter]:bg-[#0b1220]/50 border-b border-white/10">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-emerald-400 via-lime-400 to-emerald-600 p-[1px] shadow-[0_0_25px_rgba(52,211,153,.35)]">
        ...
        <button className="inline-flex items-center gap-2 rounded-lg bg-gradient-to-r from-emerald-400 to-lime-300 px-4 py-2 text-sm font-semibold text-[#0b1220] shadow-[0_10px_30px_-10px_rgba(52,211,153,.7)] hover:shadow-[0_12px_35px_-8px_rgba(163,230,53,.7)] transition-shadow">
          Launch App
        </button>
      </div>
    </header>
