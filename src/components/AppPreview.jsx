          ...
          <div className="xl:col-span-1 rounded-2xl border border-white/10 bg-white/5 backdrop-blur overflow-hidden flex flex-col">
            ...
            >
              <div className="flex items-center gap-2">
                ...
                />
                <button type="submit" className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-emerald-400 to-lime-300 px-3 py-2 text-[#0b1220] text-sm font-semibold">
            ...
            <div className="p-6 grid lg:grid-cols-2 gap-6">
              <div className="rounded-xl border border-white/10 bg-[#0d1526]/70 p-4">
                ...
                <div className="mt-3 grid grid-cols-2 gap-3">
                  <div className="aspect-video rounded-lg bg-gradient-to-br from-emerald-500/20 to-lime-400/10 ring-1 ring-white/10" />
                  <div className="aspect-video rounded-lg bg-gradient-to-br from-emerald-500/20 to-lime-400/10 ring-1 ring-white/10" />
