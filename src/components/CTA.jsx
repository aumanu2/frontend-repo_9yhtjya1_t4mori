        ...
        <div className="relative overflow-hidden rounded-2xl border border-white/10 bg-gradient-to-br from-[#0e1627] to-[#0b1220] p-8 sm:p-12">
          ...
          <div className="flex flex-col items-center text-center">
            ...
            <div className="mt-8 flex flex-col sm:flex-row gap-4">
              ...
              <button className="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-emerald-400 to-lime-300 px-6 py-3 text-[#0b1220] font-semibold shadow-[0_20px_60px_-20px_rgba(52,211,153,.7)] hover:shadow-[0_24px_70px_-18px_rgba(163,230,53,.7)] transition-shadow">
                Start analyzing
              </button>
            </div>
